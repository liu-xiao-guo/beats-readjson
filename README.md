...
`${GOPATH}/src/github.com/liu-xiao-guo/readjson`
...
```
git remote set-url origin https://github.com/liu-xiao-guo/readjson
...
in the same directory with the name readjson.
...
```
mkdir -p ${GOPATH}/src/github.com/liu-xiao-guo/readjson
git clone https://github.com/liu-xiao-guo/readjson ${GOPATH}/src/github.com/liu-xiao-guo/readjson
```
